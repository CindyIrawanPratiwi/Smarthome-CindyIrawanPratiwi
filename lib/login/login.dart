  ...
  Widget _buildForm() {
    return Column(
      ...
      children: [
        ...
        _buildInputField2(passwordController,
            isPassword: true, hintPassword: 'Enter your password'),
  ...
  Widget _buildInputField(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
          hintText: isPassword ? hintPassword : 'Enter your username/email',
          isDense: true,
...
// Widget _buildLoginButton() {
//   String errorMessage = ''; // Add this variable to store error messages.

//   return ElevatedButton(
//     onPressed: () {
//       if (emailController.text == 'tugas@gmail.com' &&
...
//         );
//       } else {
//         // Update the error message based on the incorrect field(s).
//         if (emailController.text != 'tugas@gmail.com') {
